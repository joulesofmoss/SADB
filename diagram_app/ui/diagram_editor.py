from PyQt6.QtWidgets import (QMainWindow, QGraphicsView, QGraphicsScene, QWidget, QFormLayout, QDockWidget, QLineEdit, QLabel, QInputDialog, QVBoxLayout, QHBoxLayout, QSplitter, QFileDialog, QMessageBox, QTextEdit)
...
class DiagramEditor(QMainWindow):
 ...
 #       from PyQt6.QtWidgets import QMessageBox
  #      QMessageBox.information(self, "Threat Analysis", "Threat analysis feature coming soon!")    
